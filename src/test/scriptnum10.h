...
#ifndef METHUSELAH_TEST_SCRIPTNUM10_H
#define METHUSELAH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Methuselah Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // METHUSELAH_TEST_BIGNUM_H

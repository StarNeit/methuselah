 ...
 */
#ifndef METHUSELAH_UTIL_H
#define METHUSELAH_UTIL_H
...
extern const char * const METHUSELAH_CONF_FILENAME;
extern const char * const METHUSELAH_PID_FILENAME;
...
{
    std::string s = strprintf("methuselah-%s", name);

...
class RawTransactionsTest(MethuselahTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid methuselah address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid methuselah address" in e.error['message'])

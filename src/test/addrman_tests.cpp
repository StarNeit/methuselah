...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    BOOST_CHECK(addr_ret1.ToString() == "250.1.1.1:7555");
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    BOOST_CHECK(addr_ret2.ToString() == "250.1.1.1:7555");
    ...
    BOOST_CHECK(addr_ret3.ToString() == "250.1.1.1:7555");
}
...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    BOOST_CHECK(addrman.Select().ToString() == "250.4.6.6:7555");
    BOOST_CHECK(addrman.Select().ToString() == "250.3.2.2:9999");
    BOOST_CHECK(addrman.Select().ToString() == "250.3.3.3:9999");
    BOOST_CHECK(addrman.Select().ToString() == "250.4.4.4:7555");
}
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    BOOST_CHECK(info1);
    if (info1)
        BOOST_CHECK(info1->ToString() == "250.1.2.1:7555");
    ...
    BOOST_CHECK(info3);
    if (info3)
        BOOST_CHECK(info3->ToString() == "251.255.2.1:7555");
}
...
BOOST_AUTO_TEST_CASE(addrman_create)
{
    ...
    BOOST_CHECK(pinfo->ToString() == "250.1.2.1:7555");

    CAddrInfo* info2 = addrman.Find(addr1);
    BOOST_CHECK(info2->ToString() == "250.1.2.1:7555");
}

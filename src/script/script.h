...
#ifndef METHUSELAH_SCRIPT_SCRIPT_H
#define METHUSELAH_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Methuselah always counted CHECKMULTISIGs
...
#endif // METHUSELAH_SCRIPT_SCRIPT_H

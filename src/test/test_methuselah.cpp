...
#define BOOST_TEST_MODULE Methuselah Test Suite

#include "test_methuselah.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_methuselah_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

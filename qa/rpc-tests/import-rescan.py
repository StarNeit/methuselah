...
import RPC call and node 0 sends SAP to it. Then other nodes import the
...
In the second part of the test, node 0 sends more SAP to each address, and the
...
class ImportRescanTest(MethuselahTestFramework):
    def __init__(self):
        super().__init__()

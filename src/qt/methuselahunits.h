...
#ifndef METHUSELAH_QT_METHUSELAHUNITS_H
#define METHUSELAH_QT_METHUSELAHUNITS_H
...
/** Methuselah unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MethuselahUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MethuselahUnits(QObject *parent);

    /** Methuselah units.
      @note Source: https://en.methuselah.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SAP,
...
typedef MethuselahUnits::Unit MethuselahUnit;

#endif // METHUSELAH_QT_METHUSELAHUNITS_H

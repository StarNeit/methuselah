#!/usr/bin/env python3
# Copyright (c) 2017 The Methuselah Developers
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if methuselahd ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(MethuselahTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 1

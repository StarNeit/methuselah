...
#ifndef METHUSELAH_POW_H
#define METHUSELAH_POW_H
...
enum DiffMode {
    ...
    DIFF_D601     = 5, // Retarget using D601
};

unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params&);
uint32_t GetNextWorkRequiredD601(const CBlockIndex *pindexPrev, const CBlockHeader *pblock, const Consensus::Params &params);

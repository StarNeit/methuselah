...
###   This script attempts to download the signature file SHA256SUMS.asc from methuselah.org
...
WORKINGDIR="/tmp/methuselah_verify_binaries"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test"
BASEDIR="https://methuselah.org/bin/"
VERSIONPREFIX="methuselah-core-"
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Methuselah Core binary release signing key installed?"
   fi

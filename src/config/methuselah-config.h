/* src/config/methuselah-config.h.  Generated from methuselah-config.h.in by configure.  */
/* src/config/methuselah-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef METHUSELAH_CONFIG_H

#define METHUSELAH_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "Methuselah Developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "METHUSELAH"
...
#define PACKAGE_BUGREPORT "https://github.com/methuselah-coin/methuselah/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Methuselah Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Methuselah Core 1.14.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "methuselah"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://methuselahcoin.io/"

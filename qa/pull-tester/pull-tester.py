...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old MethuselahPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/MethuselahdComparisonTool_jar/MethuselahdComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/methuselah-coin/methuselah.git")
...
environ_default("BUILD_PATH", "/mnt/methuselah")
...
environ_default("GITHUB_REPO", "methuselah/methuselah")

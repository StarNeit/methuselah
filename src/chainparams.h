...
#ifndef METHUSELAH_CHAINPARAMS_H
#define METHUSELAH_CHAINPARAMS_H
 ...
 * Methuselah system. There are three: the main network on which people trade goods
...
#endif // METHUSELAH_CHAINPARAMS_H

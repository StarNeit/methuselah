...
METHUSELAHD=${1}/methuselahd
CLI=${1}/methuselah-cli
...
B4ARGS="-datadir=$D4"
$METHUSELAHD $METHUSELAHDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$METHUSELAHD $METHUSELAHDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $METHUSELAHD $METHUSELAHDARGS $B1ARGS &
  B1PID=$!
  $METHUSELAHD $METHUSELAHDARGS $B2ARGS &
  B2PID=$!
  $METHUSELAHD $METHUSELAHDARGS $B3ARGS &
  B3PID=$!
}

...
#ifndef METHUSELAH_WALLET_WALLET_H
#define METHUSELAH_WALLET_WALLET_H
...
static const unsigned int DEFAULT_KEYPOOL_SIZE = 300; //for btc it is 100
//! -paytxfee default
...
public:
     ...
     * on this methuselah node, and set to 0 for transactions that were created
...
#endif // METHUSELAH_WALLET_WALLET_H

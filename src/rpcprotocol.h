...
#ifndef METHUSELAH_RPCPROTOCOL_H
#define METHUSELAH_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! methuselah is not connected
...
#endif // methuselah_RPCPROTOCOL_H

...
class WalletTest (MethuselahTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 SAP from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SAP with subtract fee from amount
        ...
        # Sendmany 10 SAP with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/methuselah-coin/methuselah/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
